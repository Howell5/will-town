...
export const shops = [
  { id: 'journal' as const, x: -2.5, label: '开发手记', sign: 'DEVLOG', number: '02', accent: '#799b86', title: '把想法，一点点变成现实。', subtitle: '小镇建造日志', description: '这里记录小镇从一张概念图到像素街景的过程。场景、素材、交互和昼夜变化，都在持续生长。', url: 'https://github.com/Howell5/will-town', cta: '查看开发仓库' },
